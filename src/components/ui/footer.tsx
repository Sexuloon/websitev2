...
const Footer = () => {
  const [openMenu, setOpenMenu] = useState({ quick: false, conditions: false, support: false });
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden space-y-6 text-center">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-md overflow-hidden">
              ...
              >
                Quick Links
                <span className={`transform transition-transform ${openMenu.quick ? 'rotate-180' : ''}`}>▼</span>
              </button>
              <ul className={`px-4 pb-3 space-y-2 text-gray-400 text-lg transition-all duration-300 ${openMenu.quick ? 'block' : 'hidden'}`}>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-md overflow-hidden">
              ...
              >
                Conditions
                <span className={`transform transition-transform ${openMenu.conditions ? 'rotate-180' : ''}`}>▼</span>
              </button>
              <ul className={`px-4 pb-3 space-y-2 text-gray-400 text-lg transition-all duration-300 ${openMenu.conditions ? 'block' : 'hidden'}`}>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-md overflow-hidden">
              ...
              >
                Support
                <span className={`transform transition-transform ${openMenu.support ? 'rotate-180' : ''}`}>▼</span>
              </button>
              <ul className={`px-4 pb-3 space-y-2 text-gray-400 text-lg transition-all duration-300 ${openMenu.support ? 'block' : 'hidden'}`}>
