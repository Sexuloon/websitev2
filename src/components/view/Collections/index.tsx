  ...
  if (isLoading) {
    return (
      <div className="w-full py-8 px-4 max-w-7xl mx-auto">
        ...
        <div className="sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 sm:gap-8">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 sm:hidden scrollbar-hide">
          {data?.collections.edges.map((collection) => (
            <div
              ...
              className="flex-none w-64 group cursor-pointer transform transition-all duration-300 hover:scale-105"
            >
