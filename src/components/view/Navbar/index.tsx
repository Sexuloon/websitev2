        ...
        <div className="flex items-center gap-3">
          ...
          <SignedOut>
            <SignInButton mode="modal">
              <button className="hidden sm:flex items-center justify-center border border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-[#C9A84C]/50 dark:text-[#C9A84C] dark:hover:bg-[#C9A84C]/10 dark:hover:border-[#C9A84C] rounded-full font-semibold text-sm h-10 px-5 transition-all duration-200 cursor-pointer">
                Sign In
              </button>
            </SignInButton>
          ...
          <div className="flex flex-col gap-1">
            ...
            <SignedOut>
              <div className="flex gap-3 pb-4 mb-2 border-b border-gray-100 dark:border-[#1e1e1e]">
                <SignInButton mode="modal">
                  <button className="flex-1 border border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-[#C9A84C]/50 dark:text-[#C9A84C] dark:hover:bg-[#C9A84C]/10 rounded-full font-semibold text-sm h-11 transition-all">
                    Sign In
                  </button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button className="flex-1 bg-black text-white hover:bg-gray-800 dark:bg-[#1a4731] dark:hover:bg-[#143828] rounded-full font-semibold text-sm h-11 transition-all">
                    Sign Up
                  </button>
                </SignUpButton>
              </div>
