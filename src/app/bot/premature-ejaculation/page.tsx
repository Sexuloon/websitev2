...
export default function PEChatbot() {
  ...
  const questions = {
    english: {
      ...
      doctorConsult: {
        question: "Would you like to speak with a certified doctor for a personalized plan?",
        options: [
          "Yes",
          "No",
          "Maybe later"
    ...
    hindi: {
      ...
      frequency: {
        question: "क्या आप अक्सर संभोग के दौरान अपनी इच्छा से पहले स्खलित हो जाते हैं?",
        options: [
          "हमेशा",
          "अक्सर",
          "कभी-कभी",
      ...
      situations: {
        question: "क्या यह समस्या हर यौन गतिविधि में होती है या कुछ खास स्थितियों में?",
        options: [
          "हर स्थिति में",
          "सिर्फ कुछ खास स्थितियों में"
        ]
      },
      anxiety: {
      ...
      impact: {
        question: "क्या इस समस्या से आपके आत्मविश्वास या रिश्तों पर असर पड़ा है?",
        options: [
          "हाँ",
          "नहीं",
          "थोड़ा बहुत"
  ...
  const generateRecommendation = () => {
    ...
    const frequentIssue = answers.frequency === 'Always' || answers.frequency === 'Often' || 
                         answers.frequency === 'हमेशा' || answers.frequency === 'अक्सर';
    const highAnxiety = answers.anxiety === 'Yes' || answers.anxiety === 'हाँ';
    const poorLifestyle = answers.lifestyle === 'Daily' || answers.lifestyle === 'रोज़ाना';
    const inactive = answers.activity === 'Not Active' || answers.activity === 'कम सक्रिय';
    const significantImpact = answers.impact === 'Yes' || answers.impact === 'हाँ';
    const hasHealthConditions = answers.health !== 'None of these' && answers.health !== 'इनमें से कोई नहीं';

    if (hasChronicSymptoms || frequentIssue || highAnxiety || poorLifestyle || inactive || significantImpact || hasHealthConditions) {
      return 'doctor';
    } else {
      return 'supplement';
    }
        ...
        {step !== 'language' && step !== 'recommendation' && (
          ...
          >
            <div className="flex justify-between text-xs text-gray-500 mb-1">
              <span>Step {getCurrentStepNumber()}/{totalSteps - 2}</span>
