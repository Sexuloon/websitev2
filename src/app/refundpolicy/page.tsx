      ...
      <div className="pt-24 pb-16 px-4 sm:px-10 md:px-20 min-h-screen">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mb-6 text-lg leading-relaxed">
            At <span className="italic font-semibold">Sexuloon</span>, we aim to
            ensure your satisfaction and trust in every interaction. If, for any
            reason, you are not completely satisfied with your purchase, we
            offer a simple and hassle-free refund process.
          </p>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>
                Product not as described or does not match the specifications.
              </li>
            </ul>
            <p className="mt-2">
              Requests must be made within{" "}
              <span className="font-medium">48 hours</span> of receiving the
              product.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p>
              You can raise a refund request by contacting our support via email
              or live chat. Once the issue is verified and approved:
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>
                The refund will be{" "}
              ...
              <li>
                You will be notified via email regarding the refund status.
              </li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <p>
              The refunded amount will be credited to your original payment
              method or source within{" "}
          ...
          <div className="mb-6">
            ...
            <p>
              To maintain hygiene and safety, the following items are not
          ...
          <div className="mb-6">
            ...
            <p>
              ...
              <span className="font-medium">1 hour</span> of placement or before
              the order is shipped, whichever is earlier. Once dispatched,
